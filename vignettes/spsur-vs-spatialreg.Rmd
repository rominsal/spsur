...
date: "2020-04-07 16:56:19 <br>  <br> <br>"
output: 
...
#> Time to fit the model:  0.95  seconds
#> Time to compute covariances:  4.64  seconds
```
...
#> sim model     1  8 18369 -9176.3    1                
#> slm model     2  9 18215 -9098.6    2  155.54       0
```
...
#> Time to fit the model:  1.85  seconds
#> Time to compute covariances:  65.04  seconds
```
...
#>           Model df   AIC  logLik Test L.Ratio p-value
#> sim model     1  8 18369 -9176.3    1                
#> sem model     2  9 18230 -9106.1    2  140.48       0
```
...
#> Time to fit the model:  43.53  seconds
#> Time to compute covariances:  9.9  seconds
```
...
```
#>             Model df   AIC  logLik Test L.Ratio p-value
#> slm model       1  9 18215 -9098.6    1                
#> sarar model     2 10 18141 -9060.3    2  76.625       0
```
...
```
#>             Model df   AIC  logLik Test L.Ratio p-value
#> sem model       1  9 18230 -9106.1    1                
#> sarar model     2 10 18141 -9060.3    2  91.687       0
```
