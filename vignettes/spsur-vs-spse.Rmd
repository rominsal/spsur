...
date: "2020-04-09 14:26:27 <br>  <br> <br>"
output: 
  html_document:
    df_print: kable
    highlight: tango
...
```
## Error in loadNamespace(name): there is no package called 'spse'
```
...
```
## Error in list.spse.N52.slm[[i]]: subíndice fuera de  los límites
```
...
```
## Error in list.spse.N525.slm[[i]]: subíndice fuera de  los límites
```
...
```
## Error in list.spse.sem.N52[[i]]: subíndice fuera de  los límites
```
...
```
## Error in list.spse.sem.N525[[i]]: subíndice fuera de  los límites
```
